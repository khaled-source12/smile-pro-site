...
function fontCss(locale, pageKind) {
  ...
  if (locale === "ar") {
    return `@font-face{font-family:"Cairo";font-style:normal;font-display:swap;font-weight:200 1000;src:url(${manifest["font/cairo-arabic"]}) format("woff2");unicode-range:${arabicRange}}@font-face{font-family:"Cairo";font-style:normal;font-display:swap;font-weight:200 1000;src:url(${manifest["font/cairo-latin"]}) format("woff2");unicode-range:${latinRange}}`;
  }
  const dmSans = `@font-face{font-family:"DM Sans";font-style:normal;font-display:swap;font-weight:100 1000;src:url(${manifest["font/dm-sans"]}) format("woff2");unicode-range:${latinRange}}`;
  if (pageKind === "calculator" || pageKind === "thank-you") {
    return `${dmSans}@font-face{font-family:"Cormorant Garamond";font-style:normal;font-display:swap;font-weight:300 700;src:url(${manifest["font/cormorant-garamond"]}) format("woff2");unicode-range:${latinRange}}@font-face{font-family:"Cormorant Garamond";font-style:italic;font-display:swap;font-weight:300 700;src:url(${manifest["font/cormorant-garamond-italic"]}) format("woff2");unicode-range:${latinRange}}`;
  }
  return `${dmSans}@font-face{font-family:"Space Grotesk";font-style:normal;font-display:swap;font-weight:300 700;src:url(${manifest["font/space-grotesk"]}) format("woff2");unicode-range:${latinRange}}`;
}
